...
namespace eTicketsProject.Migrations
{
    ...
    [Migration("20240208120644_Identity_Added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eTicketsProject.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eTicketsProject.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eTicketsProject.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eTicketsProject.Models.Actor_Movie", b =>
                {
                    b.HasOne("eTicketsProject.Models.Actor", "Actor")
            ...
            modelBuilder.Entity("eTicketsProject.Models.Movie", b =>
                {
                    b.HasOne("eTicketsProject.Models.Cinema", "Cinema")
                        .WithMany("Movies")
                        .HasForeignKey("CinemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eTicketsProject.Models.Producer", "Producer")
                        .WithMany("Movies")
